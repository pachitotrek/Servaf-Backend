...
/***/ "./src/app/pipes/download.pipe.ts":
/*!****************************************!*\
  !*** ./src/app/pipes/download.pipe.ts ***!
  \****************************************/
/*! exports provided: DownloadPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DownloadPipe", function() { return DownloadPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var DownloadPipe = /** @class */ (function () {
    function DownloadPipe() {
    }
    DownloadPipe.prototype.transform = function (img, tipo) {
        if (tipo === void 0) { tipo = 'usuario'; }
        var url = _services_global__WEBPACK_IMPORTED_MODULE_2__["Global"].url + 'down';
        if (!img) {
    ...
    DownloadPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ImagenPipe = /** @class */ (function () {
    ...
    ImagenPipe.prototype.transform = function (img, tipo) {
        if (tipo === void 0) { tipo = 'usuario'; }
        var url = _services_global__WEBPACK_IMPORTED_MODULE_2__["Global"].url + 'img';
        if (!img) {
            return url + '/usuarios/xxx';
        }
        if (img.indexOf('https') >= 0) {
        ...
        switch (tipo) {
            ...
            case 'tienda':
                ...
                break;
            case 'videos':
                url = _services_global__WEBPACK_IMPORTED_MODULE_2__["Global"].url + 'stream/' + img;
                //  url += '/videos/' + img;
                break;
            default:
                console.log('Error no se encuentra imagen');
...
/* harmony import */ var _download_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./download.pipe */ "./src/app/pipes/download.pipe.ts");
    ...
    PipesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _download_pipe__WEBPACK_IMPORTED_MODULE_4__["DownloadPipe"]
            ],
            exports: [
                _images_pipe__WEBPACK_IMPORTED_MODULE_2__["ImagenPipe"],
                _safe_pipe__WEBPACK_IMPORTED_MODULE_3__["SafePipe"]
