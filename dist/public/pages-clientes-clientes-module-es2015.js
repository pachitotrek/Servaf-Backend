...
let ClientesPage = class ClientesPage {
    ...
    crear() {
        this.aux.createLoading().then((x) => {
            this.api.crearClientes(this.form.value).subscribe((resp) => {
                console.log(resp);
                if (resp.ok) {
    ...
    update() {
        this.aux.createLoading().then((x) => {
            this.api.editClientes(this.form.value).subscribe((resp) => {
                console.log(resp);
                if (resp.ok) {
                    this.aux.dismissLoading().then((b) => {
...
//# sourceMappingURL=pages-clientes-clientes-module-es2015.js.map