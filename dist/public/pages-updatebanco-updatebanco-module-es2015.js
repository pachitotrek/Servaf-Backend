...
let UpdateComponent = class UpdateComponent {
    constructor(api, aux, eventos, modalController) {
        this.api = api;
        this.aux = aux;
    ...
    crear() {
        this.aux.createLoading().then((x) => {
            this.api.updateBanco(this.form.value).subscribe((resp) => {
                if (resp.ok) {
...
let UpdatebancoPageRoutingModule = class UpdatebancoPageRoutingModule {
};
...
let UpdatebancoPageModule = class UpdatebancoPageModule {
};
...
let UpdatebancoPage = class UpdatebancoPage {
...
UpdatebancoPage.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
    { type: src_app_services_auxiliar_service__WEBPACK_IMPORTED_MODULE_3__["AuxService"] },
...
//# sourceMappingURL=pages-updatebanco-updatebanco-module-es2015.js.map