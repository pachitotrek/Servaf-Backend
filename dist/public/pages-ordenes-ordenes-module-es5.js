...
var CrearComponent = /** @class */ (function () {
    function CrearComponent(api, modal, eventos, aux, router) {
        var _this = this;
        this.api = api;
        this.modal = modal;
        ...
        this.norma = [];
        this.orden = [];
        this.subscripcion = eventos.getNewClient().subscribe(function (x) {
            _this.getClientes();
        });
    ...
    CrearComponent.prototype.portChange = function (event) {
        console.log('port:', event.value);
    };
    CrearComponent.prototype.save = function () {
        var _this = this;
        this.aux.createLoading().then(function (x) {
            _this.api.crearOrden(_this.form.value).subscribe(function (resp) {
                if (resp.ok) {
                    _this.aux.dismissLoading().then(function (b) {
                        _this.orden = resp.data;
                        _this.router.navigate(['/ordenes/medidores'], { queryParams: { id: _this.orden._id } });
                    });
                }
            });
        }).catch(function (e) {
    ...
    CrearComponent.prototype.getClientes = function () {
        var _this = this;
    ...
    CrearComponent.prototype.getNormas = function () {
        var _this = this;
    ...
    CrearComponent.prototype.setNorma = function (item) {
        this.norma = this.normas.find(function (e) { return e.norma == item; });
    };
    CrearComponent.prototype.addcliente = function () {
...
var ItemsComponent = /** @class */ (function () {
    function ItemsComponent(modalController, route, api, eventos, aux, router) {
        ...
        this.id = "";
        this.medidores = [];
        this.medidor$ = eventos.getNewMedidor().subscribe(function (x) {
    ...
    //   })
    // }
    ItemsComponent.prototype.continue = function () {
...
var OrdenesPageRoutingModule = /** @class */ (function () {
    function OrdenesPageRoutingModule() {
    }
    ...
    return OrdenesPageRoutingModule;
}());
...
var ReviewComponent = /** @class */ (function () {
    function ReviewComponent(route, api, router) {
        this.route = route;
        this.api = api;
        this.router = router;
        this.id = "";
    ...
    ReviewComponent.prototype.getMedidores = function (id) {
        // this.api.getMedidoresOrden(id).subscribe((resp:any)=>{
        //   if(resp.ok){
        //     this.medidores=resp.data;        
        //   }
    ...
    ReviewComponent.prototype.getOrden = function (id) {
        var _this = this;
    ...
    ReviewComponent.prototype.continue = function () {
...
//# sourceMappingURL=pages-ordenes-ordenes-module-es5.js.map