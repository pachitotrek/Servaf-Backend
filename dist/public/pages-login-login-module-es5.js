...
var LoginPage = /** @class */ (function () {
    function LoginPage(us, router, local, loadingController, alertController) {
        this.us = us;
        this.router = router;
        this.local = local;
    ...
    LoginPage.prototype.login = function () {
        var _this = this;
        this.cargando();
        this.us.login(this.form.value).subscribe(function (resp) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var close_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!resp) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.hideLoader()];
                    case 1:
                        close_1 = _a.sent();
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.hideLoader()];
                    case 1:
                        close = _a.sent();
                        this.form.reset();
                        setTimeout(function () {
...
var UserService = /** @class */ (function () {
    function UserService(http, events, local) {
        this.http = http;
        this.events = events;
        this.local = local;
        this.usuario = [];
    ...
    UserService.prototype.googleAuth = function (token) {
        var _this = this;
        var data = JSON.stringify({ token: token });
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.post(this.url + 'loging', data, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) {
            _this.local.SaveStorage('usuario', resp.usuarioDB);
            _this.local.SaveStorage('token', resp.token);
            _this.cargarStorage();
    ...
    UserService.prototype.Logeado = function () {
    ...
    UserService.prototype.login = function (datos) {
        var _this = this;
        var data = JSON.stringify(datos);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json");
        return this.http.post(this.url + 'login', data, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) {
            _this.local.SaveStorage('usuario', resp.usuarioDB);
            _this.local.SaveStorage('token', resp.token);
            _this.cargarStorage();
            return resp.ok;
