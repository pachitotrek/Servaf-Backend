...
var ManualPage = /** @class */ (function () {
    ...
    ManualPage.prototype.get = function () {
        var _this = this;
        this.api.GetTutoriales().subscribe(function (resp) {
            if (resp.ok) {
                _this.items = resp.data;
            }
        });
    };
    ManualPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-manual-manual-module-es5.js.map