...
let AjustesComponent = class AjustesComponent {
    constructor(api, route, router, us, ls, aux) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.us = us;
    ...
    setMedidores() {
        this.ls.cargarStorage('medidores').then((data) => {
...
AjustesComponent.ctorParameters = () => [
...
let CalibrarComponent = class CalibrarComponent {
    ...
    getOrden(id) {
        this.api.GetOrdenClosed(id).subscribe((resp) => {
            if (resp.ok) {
...
let CertificadosComponent = class CertificadosComponent {
    ...
    getOrdenes() {
        this.api.GetCloseOrden(this.form.value).subscribe((resp) => {
            if (resp.ok) {
...
CertificadosComponent.ctorParameters = () => [
...
let ConsultarComponent = class ConsultarComponent {
    ...
    ngOnInit() { }
    get() {
        this.api.certificadoTrabajo(this.form.value).subscribe((resp) => {
            if (resp.ok) {
                this.ordenes = resp.data;
...
let CrearComponent = class CrearComponent {
    ...
    getMedidores() {
        this.api.getMedidoresSave().subscribe((resp) => {
            if (resp.ok) {
...
let CtrabajoComponent = class CtrabajoComponent {
    constructor(route, api, titleService) {
        this.route = route;
        this.api = api;
    ...
    getOrden(id) {
        this.api.certificadoOrdenTrabajo(id).subscribe((resp) => {
            if (resp.ok) {
                this.orden = resp.data[0];
    ...
    getMedidores(id) {
        this.api.certificadoOrdenTrabajoMedidores(id).subscribe((resp) => {
            if (resp.ok) {
                this.medidores = resp.data;
            }
        });
...
CtrabajoComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
...
let EditarmedidorComponent = class EditarmedidorComponent {
    constructor(api, aux, modalController, eventos) {
        ...
        this.modelos$ = eventos.getNewModelo().subscribe((x) => {
            this.getModelos();
        });
        this.marcas$ = eventos.getNewMarca().subscribe((x) => {
            this.getMarcas();
        });
        this.incidencia$ = eventos.getNewIncidencia().subscribe((x) => {
            this.getIncidencias();
        });
    }
    ngOnInit() {
    ...
    getModelos() {
        this.api.getModelo().subscribe((resp) => {
            if (resp.ok) {
    ...
    getMarcas() {
        this.api.getMarcas().subscribe((resp) => {
            if (resp.ok) {
    ...
    getIncidencias() {
        this.api.getIncidencias().subscribe((resp) => {
            if (resp.ok) {
    ...
    crear() {
        this.aux.createLoading().then((x) => {
            this.api.updateMedidor(this.form.value).subscribe((resp) => {
                if (resp.ok) {
                    this.aux.dismissLoading().then((b) => {
...
EditarmedidorComponent.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
...
let EditarmetrologicasComponent = class EditarmetrologicasComponent {
    constructor() { }
    ngOnInit() { }
};
...
let Editarmetrologicas2Component = class Editarmetrologicas2Component {
    constructor(api, aux, modalController, eventos) {
        this.api = api;
        this.aux = aux;
        this.modalController = modalController;
    ...
    crear() {
        this.aux.createLoading().then((x) => {
            this.api.updateMedidor2(this.form.value).subscribe((resp) => {
                if (resp.ok) {
                    this.aux.dismissLoading().then((b) => {
                        this.aux.createAlert("Exito", "El Medidor ha sido actualizado");
                        this.modalController.dismiss();
...
Editarmetrologicas2Component.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
    { type: src_app_services_auxiliar_service__WEBPACK_IMPORTED_MODULE_4__["AuxService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"] },
    { type: src_app_services_eventos_service__WEBPACK_IMPORTED_MODULE_6__["EventosService"] }
...
let FinalesComponent = class FinalesComponent {
    ...
    getTrabajo(id) {
        this.api.getOrdenTrabajo(id).subscribe((resp) => {
            if (resp.ok) {
    ...
    save() {
        this.api.updateTest(this.id, this.tipo).subscribe((resp) => {
            if (resp.ok) {
                this.api.condiciones(this.form.value).subscribe((resp) => {
                    if (resp.ok) {
...
FinalesComponent.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
...
let GenerarComponent = class GenerarComponent {
    constructor(api, titleService, alertController, route, router, aux) {
        this.api = api;
        this.titleService = titleService;
    ...
    getMedidor(id) {
        this.aux.createLoading().then((x) => {
            this.api.getMedidor(id).subscribe((resp) => {
                if (resp.ok) {
                    ...
                    if (this.item.type == "3") {
                        this.api.getnominaluno(this.metologicas.clase, this.metologicas.diametro).subscribe((resp) => {
                            if (resp.ok) {
                        ...
                        this.api.getnominaldos(this.metologicas.relacion, this.metologicas.diametro).subscribe((resp) => {
                            if (resp.ok) {
                                this.nominales = resp.data.valores;
                                this.nominaluno = this.nominales[0];
                                this.nominaldos = this.nominales[1];
    ...
    descargar(id, tipo) {
        this.api.downloadCertificado(id, tipo).subscribe((resp) => {
            if (resp.ok) {
...
let InformedosComponent = class InformedosComponent {
    constructor(route, api) {
        this.route = route;
        this.api = api;
        this.ready = false;
    ...
    get(id) {
        this.api.getMedidor3(id).subscribe((resp) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (resp.ok) {
                this.item = yield resp.data[0];
                this.imagenes = yield this.item.imagenes;
                this.ready = true;
                setTimeout(() => {
                    this.print();
                }, 1000);
...
InformedosComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let InicialesComponent = class InicialesComponent {
    constructor(api, route, router) {
        this.api = api;
        this.route = route;
        this.router = router;
...
InicialesComponent.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
...
let InstrumentosComponent = class InstrumentosComponent {
    constructor(api, route, router, aux) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.aux = aux;
    ...
    getDefault() {
        this.api.getDefaultInstrumentos().subscribe((resp) => {
            if (resp.ok) {
                this.default = resp.data[0];
    ...
    save() {
        ...
        this.api.addInstrumentosTrabajo(a).subscribe((resp) => {
            if (resp.ok) {
...
let ListamedidoresComponent = class ListamedidoresComponent {
    constructor(api, router) {
        this.api = api;
        this.router = router;
        this.items = [];
    ...
    get() {
        this.api.getMedidores(this.form.value).subscribe((resp) => {
            if (resp.ok) {
...
ListamedidoresComponent.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
];
...
let MedidorComponent = class MedidorComponent {
    constructor(api, alertController, route, router, modalController, eventos, aux) {
        this.api = api;
        this.alertController = alertController;
        this.route = route;
        this.router = router;
    ...
    generar() {
        this.aux.createLoading().then((x) => {
            ...
            this.api.terminarorden(a).subscribe((resp) => {
                if (resp.ok) {
                    this.aux.dismissLoading().then((b) => {
    ...
    crear() {
        this.aux.createLoading().then((x) => {
            this.api.derogar(this.form.value).subscribe((resp) => {
                if (resp.ok) {
                    this.aux.dismissLoading().then((b) => {
...
MedidorComponent.ctorParameters = () => [
    { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
let OrdenesComponent = class OrdenesComponent {
    ...
    getOrdenes() {
        this.api.getOrdenesTrabajo().subscribe((resp) => {
            if (resp.ok) {
                this.ordenes = resp.data;
            }
        });
...
/* harmony import */ var ionic_selectable__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ionic-selectable */ "./node_modules/ionic-selectable/esm2015/ionic-selectable.min.js");
...
let PruebasComponent = class PruebasComponent {
    constructor(router, route, alertController, api, aux, lc) {
        this.router = router;
        this.route = route;
        this.alertController = alertController;
        this.api = api;
    ...
    getOrden(id) {
        this.api.getOrdenTrabajo(id).subscribe((resp) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (resp.ok) {
    ...
    setuser() {
        this.lc.cargarStorage('usuario').then((data) => {
            this.usuario = data;
        });
    }
    close() {
...
let Q1Component = class Q1Component {
    constructor(route, router, api, lc) {
        this.route = route;
        this.router = router;
        this.api = api;
        this.lc = lc;
...
let Q3Component = class Q3Component {
    constructor() { }
    ngOnInit() { }
};
...
//# sourceMappingURL=pages-programacion-programacion-module-es2015.js.map