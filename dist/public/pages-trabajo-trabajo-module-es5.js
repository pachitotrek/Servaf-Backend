...
var AddmedidoresComponent = /** @class */ (function () {
    function AddmedidoresComponent(api, route, router) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.medidores = [];
    ...
    AddmedidoresComponent.prototype.ngOnInit = function () {
        this.id = this.route.snapshot.paramMap.get("id");
        this.getTrabajo(this.id);
    };
    AddmedidoresComponent.prototype.getTrabajo = function (id) {
    ...
    AddmedidoresComponent.prototype.getMedidores = function (id) {
    ...
    AddmedidoresComponent.prototype.push = function (item) {
        this.seleccionados.push(item);
        this.medidores = this.medidores.filter(function (e) { return e._id != item._id; });
        console.log(this.seleccionados);
    };
    AddmedidoresComponent.prototype.delete = function (item) {
        this.seleccionados = this.seleccionados.filter(function (e) { return e._id != item._id; });
        this.medidores.push(item);
    };
    AddmedidoresComponent.prototype.continue = function () {
        var _this = this;
        var a = {
            "id": this.id,
            "seleccionados": this.seleccionados
        };
        this.api.addmedidores(a).subscribe(function (resp) {
            if (resp.ok) {
                _this.router.navigate(['/trabajo/crear']);
                console.log(resp);
            }
        });
    };
    AddmedidoresComponent.ctorParameters = function () { return [
...
var CalibrarComponent = /** @class */ (function () {
    function CalibrarComponent(api, router) {
        this.api = api;
        this.router = router;
        this.ordenes = [];
    }
    ...
    CalibrarComponent.prototype.getOrdenes = function () {
    ...
    CalibrarComponent.prototype.open = function (id) {
...
var ConsultarComponent = /** @class */ (function () {
    ...
    ConsultarComponent.prototype.getOrdenes = function () {
        var _this = this;
        this.api.getOrdenesOpen().subscribe(function (resp) {
            if (resp.ok) {
                _this.ordenes = resp.data;
            }
        });
    };
    ConsultarComponent.prototype.open = function (id) {
...
var CrearComponent = /** @class */ (function () {
    function CrearComponent(api, route, router, us, ls) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.us = us;
    ...
    CrearComponent.prototype.getBancos = function () {
        var _this = this;
    ...
    CrearComponent.prototype.getDatos = function (id) {
        var _this = this;
        this.api.OpenOrden(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.datos = resp.data[0];
                _this.form.patchValue({ entrada: _this.datos._id });
                _this.q2q1 = _this.datos.q2 / _this.datos.q1;
                _this.q3q1 = _this.datos.q3 / _this.datos.q1;
            }
        });
    };
    CrearComponent.prototype.getConsecutivo = function () {
        var _this = this;
        this.api.Consecutivo().subscribe(function (resp) {
            if (resp.ok) {
                var consecutivo = resp.data[0].orden + 1;
                _this.form.patchValue({ orden: consecutivo });
            }
        });
    };
    CrearComponent.prototype.getDefault = function () {
        var _this = this;
    ...
    CrearComponent.prototype.getUsuarios = function () {
        var _this = this;
    ...
    CrearComponent.prototype.save = function () {
        var _this = this;
        this.api.crearOrdenTrabajo(this.form.value).subscribe(function (resp) {
            if (resp.ok) {
    ...
    CrearComponent.prototype.setUser = function () {
        var _this = this;
        this.ls.cargarStorage('usuario').then(function (data) {
            _this.form.patchValue({ ordenante: data._id });
        });
    };
...
var GenerarComponent = /** @class */ (function () {
    function GenerarComponent(api, alertController, route, router) {
        this.api = api;
    ...
    GenerarComponent.prototype.cerrar = function () {
    ...
    GenerarComponent.prototype.save = function () {
        var _this = this;
        var a = {
            _id: this.id
        };
        this.api.closeordentrabajo(a).subscribe(function (resp) {
            if (resp.ok) {
                _this.generate();
            }
        });
    };
    GenerarComponent.prototype.generate = function () {
        var _this = this;
        var a = {
            orden: this.id
        };
        this.api.generarinforme(a).subscribe(function (resp) {
            if (resp.ok) {
                // this.router.navigate(['/trabajo/calibrar']);
                _this.getResultados(_this.id);
            }
        });
    };
    GenerarComponent.prototype.getResultados = function (id) {
        var _this = this;
        this.api.getresultados(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.resultados = resp.data[0];
                _this.getOrden(id);
            }
        });
    };
    GenerarComponent.prototype.getOrden = function (id) {
        // this.api.GetOpenOrden(id).subscribe((resp:any)=>{
        //   if(resp.ok){
    ...
    GenerarComponent.prototype.getOrdenEntrada = function (id) {
        var _this = this;
        this.api.getOrden(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.entrada = resp.data[0];
            }
        });
    };
    GenerarComponent.prototype.getmedidores = function (id) {
        var _this = this;
        this.api.GetOMedidoresTrabajo(id).subscribe(function (resp) {
            if (resp.ok) {
    ...
    GenerarComponent.prototype.getInstrumentos = function (id) {
        var _this = this;
        this.api.getAllInstrumentosOrden(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.instrumentos = resp.data;
                _this.instrumentos.forEach(function (e) {
                    _this.caudal.push(e.caudal);
                    _this.temprvm.push(e.temprvm);
                    _this.tempagua.push(e.tempagua);
                    _this.volumenrvm.push(e.volumenrvm);
                    _this.tiempo.push(e.tiempo);
                    _this.presionentrada.push(e.presionentrada);
                    _this.tempambiente.push(e.tempambiente);
                    _this.humedad.push(e.humedad);
                    _this.presionsalida.push(e.presionsalida);
                });
                _this.ready = true;
                _this.inf = false;
            }
...
var InformesComponent = /** @class */ (function () {
    function InformesComponent(api, router) {
        this.api = api;
        this.router = router;
        this.ordenes = [];
    }
    InformesComponent.prototype.ngOnInit = function () {
        this.getOrdenes();
    };
    InformesComponent.prototype.getOrdenes = function () {
    ...
    InformesComponent.prototype.open = function (id) {
        this.router.navigate(["/trabajo/generar/" + id], { queryParams: { ok: '1' } });
    };
    InformesComponent.ctorParameters = function () { return [
        { type: src_app_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var InstrumentosComponent = /** @class */ (function () {
    function InstrumentosComponent(api, route, router) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.instrumentos = [];
    ...
    InstrumentosComponent.prototype.ionViewWillEnter = function () {
        this.id = this.route.snapshot.paramMap.get("id");
        this.getTrabajo(this.id);
        this.getInstrumentos();
    };
    ...
    InstrumentosComponent.prototype.save = function () {
        ...
        this.api.saveInstrumentosOrdenTrabajo(a).subscribe(function (resp) {
            if (resp.ok) {
                _this.router.navigate(["/trabajo/medidores/" + _this.id]);
            }
        });
    };
...
var PruebasComponent = /** @class */ (function () {
    function PruebasComponent(api, route, router, alertController) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.alertController = alertController;
    ...
    // }
    PruebasComponent.prototype.getpruebas = function (id) {
        var _this = this;
        this.api.getpruebas(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.pruebas = resp.data;
                if (_this.pruebas.length == 0) {
                    _this.router.navigate(["/trabajo/generar/" + _this.id]);
                }
                else if (_this.pruebas.length == _this.parametros.repeticiones) {
                    _this.ready = true;
                }
                else {
                }
    ...
    PruebasComponent.prototype.save = function () {
        var _this = this;
        var a = {
            _id: this.id
        };
        this.api.closeordentrabajo(a).subscribe(function (resp) {
            if (resp.ok) {
                _this.router.navigate(["/trabajo/calibrar"]);
            }
        });
    };
    PruebasComponent.prototype.generate = function () {
        var a = {
            _id: this.id
        };
        this.api.generarinforme(a).subscribe(function (resp) {
    ...
    //   })
    // }
    PruebasComponent.prototype.getdefaults = function () {
        var _this = this;
        this.api.getDefaultParametros().subscribe(function (resp) {
            if (resp.ok) {
...
var Q1Component = /** @class */ (function () {
    function Q1Component(api, route, router) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.uno = true;
    ...
    Q1Component.prototype.getMedidores = function (id) {
        var _this = this;
        this.api.GetOMedidoresTrabajo(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.medidores = resp.data;
    ...
    Q1Component.prototype.save = function () {
        ...
        this.api.iniciales(this.form.value).subscribe(function (resp) {
            if (resp.ok) {
                _this.orden = resp.data;
                _this.form2.patchValue({ _id: _this.orden._id });
                _this.dos = true;
                _this.tres = true;
            }
        });
    ...
    Q1Component.prototype.savetime = function () {
        var _this = this;
        this.api.savetime(this.form2.value).subscribe(function (resp) {
            if (resp.ok) {
                if (_this.repeticion > _this.parametros.repeticiones) {
                    _this.form.reset();
                    _this.form2.reset();
                    var a = {
                        orden: _this.id,
                    ...
                    _this.api.updatepruebas(a).subscribe(function (resp) {
                        if (resp.ok) {
                    ...
                    _this.dos = false;
                    _this.tres = false;
                    _this.router.navigate(["/trabajo/corridad/" + _this.id], { queryParams: { tipo: _this.tipo, numero: _this.repeticion } });
                }
            }
        });
    };
    Q1Component.prototype.set = function () {
...
var Q2Component = /** @class */ (function () {
    function Q2Component(api, route, router) {
        this.api = api;
        this.route = route;
        this.router = router;
        this.uno = true;
    ...
    Q2Component.prototype.getMedidores = function (id) {
        var _this = this;
        this.api.GetOMedidoresTrabajo(id).subscribe(function (resp) {
            if (resp.ok) {
                _this.medidores = resp.data;
    ...
    Q2Component.prototype.savetime = function () {
        var _this = this;
        this.api.savetime(this.form2.value).subscribe(function (resp) {
            if (resp.ok) {
                if (_this.repeticion > _this.parametros.repeticiones) {
                    ...
                    _this.router.navigate(["/trabajo/corrida/" + _this.id], { queryParams: { tipo: _this.tipo, numero: _this.repeticion } });
                }
            }
        });
    };
    Q2Component.prototype.set = function () {
        this.form.patchValue({ tipo: this.tipo });
        this.form.patchValue({ repeticion: this.repeticion });
        this.form.patchValue({ orden: this.id });
        this.repeticion++;
...
var TrabajoPageRoutingModule = /** @class */ (function () {
    function TrabajoPageRoutingModule() {
    }
    ...
    return TrabajoPageRoutingModule;
}());
...
/* harmony import */ var ngx_print__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-print */ "./node_modules/ngx-print/fesm5/ngx-print.js");
...
//# sourceMappingURL=pages-trabajo-trabajo-module-es5.js.map