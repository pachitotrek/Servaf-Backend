...
class CalculosController {
    ...
    static Vis_Volumen_indicado(Vis, item) {
    ...
    static ts_temperatura_rvm(tmax, tmin, item) {
        return new Promise((resolve, reject) => {
            //PRUEBA
            let t_max = tmax;
            let t_min = tmin;
    ...
    static tx_temperatura_agua(tmax, tmin, item) {
        return new Promise((resolve, reject) => {
            //PRUEBA
            let t_max = tmax;
            let t_min = tmin;
    ...
    static px_presion_entrada(pmax, pmin, item) {
        return new Promise((resolve, reject) => {
            //PRUEBA
            let p_max = pmax;
            let p_min = pmin;
    ...
    static vx_volumen_medidor(vx, Ts, Tx, px, vpro, Ttanque, Tagua, Pentrada, item, vis, parametros) {
    ...
    static Ex_error_relativo(vx, vpro, vime, escala) {
    ...
    static ExAv_error_repetivilidad(Pruebas, Errores, Ex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let pruebas = Pruebas;
            let errores = Errores;
            let ex = (mathjs_1.std(errores)) / (Math.sqrt(pruebas));
            let EEx = Ex;
